...
$("#success").on( 'click', function () {
	reset();
	alertify.success("Dodałeś do przyjaciół");
        $('#success').html('Wysłano zaproszenie <i class=fa fa-check></i>');
	
//        var data;
        var userid = $("#success").attr('data-userid');
        console.log(userid);
//
        jQuery.ajax({
            type: 'post',
            url: Routing.generate('feniu_frontend_friend_add'),
            data: {userid: userid},

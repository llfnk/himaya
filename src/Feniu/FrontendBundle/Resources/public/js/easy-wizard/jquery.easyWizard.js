...
//							return false;
                            ...
                            var imie = document.getElementById("user_data_imie").value;
                            console.log(imie);
                            var nazwisko = document.getElementById("user_data_nazwisko").value;
                            console.log(nazwisko);

                            jQuery.ajax({
                                type: 'post',
                                url: Routing.generate('feniu_frontend_user_edit_go'),
